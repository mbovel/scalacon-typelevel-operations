...
def test() =
  ...
  // printf("%s is %d")(36, "Ada") // fails
```
<div class="code-source"><small>Source: [`examples/1_printf.scala`](examples/1_printf.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/2_routes.scala`](examples/2_routes.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/3_vec_params_simple.scala`](examples/3_vec_params_simple.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/4_vec_params_shortcomings.scala`](examples/4_vec_params_shortcomings.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/5_tf_dotty.scala`](examples/5_tf_dotty.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/6_vec_params.scala`](examples/6_vec_params.scala)</small></div>
...
```
<div class="code-source"><small>Source: [`examples/7_vec_refinements.scala`](examples/7_vec_refinements.scala)</small></div>
